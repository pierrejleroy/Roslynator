...
namespace Roslynator.CSharp.DiagnosticAnalyzers
{
    ...
    public class LocalDeclarationStatementDiagnosticAnalyzer : BaseDiagnosticAnalyzer
    {
        ...
        private void AnalyzeLocalDeclarationStatement(SyntaxNodeAnalysisContext context)
        {
            ...
            if (MarkLocalVariableAsConstRefactoring.CanRefactor(localDeclaration, context.SemanticModel, context.CancellationToken))
            {
                context.ReportDiagnostic(
                    DiagnosticDescriptors.MarkVariableLocalAsConst,
